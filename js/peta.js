...
L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
    maxZoom: 19,
    attribution:
        '&copy; <a href="https://www.openstreetmap.org/copyright">BAPPENAS</a> - Direktorat Regional I',
}).addTo(map);
    ...
    .then((data) => {
        kabupatenData = data.features.map((feature) => {
            ...
            if (feature.properties.WADMKK === "Gresik") {
                ...
                centroid = [113.875, -7.0]; // Koordinat manual untuk pusat Sumenep
            } else {
    ...
    if (feature.properties) {
        const popupContent = `
            <div style="text-align: center;">
                ...
                <b>Provinsi:</b> ${feature.properties.WADMPR}<br>
                <b>Tingkat Stunting:</b> ${feature.properties.stunting_rate}%
            </div>
        `;
        layer.bindPopup(popupContent);
    }
...
function showLayerPanel(properties) {
    ...
    const namaKabupaten =
        properties.name || properties.WADMKK || "Tidak Diketahui";
    ...
    if (!chartContainer) {
        ...
        chartContainer.style =
            "margin-top: 15px; width: 90%; height: 300px; background: white; padding: 10px; border-radius: 5px;";
                    ...
                    backgroundColor: [
                        ...
                        ...data.map((d) => {
                            if (d.stunting_rate > 30) return "rgba(255, 0, 0, 0.7)"; // Merah
                                ...
                                return "rgba(255, 165, 0, 0.7)"; // Oranye
...
clearButton.style =
    "position: absolute; right: 25px; top: 50%; transform: translateY(-50%); cursor: pointer; font-size: 18px; display: none; color: gray;";
...
resultContainer.style =
    "position: fixed; top: 125px; right: 20px; z-index: 1000; width: 330px; background: white; list-style: none; padding: 0; margin: 0;";
        ...
        kabupatenData.forEach((kabupaten) => {
            if (kabupaten.name.toLowerCase().includes(query)) {
                ...
                li.addEventListener("click", () => {
                    ...
                    let imgSrc = kabupaten.icon_image
                        ? kabupaten.icon_image
                        : "image/default.jpg";
                    let commodity =
                        kabupaten.main_commodity !== "-"
                            ? kabupaten.main_commodity
                            : "Tidak ada data";
                    ...
                    const popupContent = `
                        <div style="text-align: center;">
                            ...
                            <b>Tingkat Stunting:</b> ${kabupaten.stunting_rate}%
                        </div>
                    `;
